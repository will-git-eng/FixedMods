package ru.will.git.reflectionmedic.integration.sponge;
...
import static ru.will.git.reflectionmedic.integration.sponge.SpongeUtils.*;
	...
	static
	{
		...
		catch (NoClassDefFoundError | ClassNotFoundException e)
		{
			if (reflectionmedicMod.debug)
				reflectionmedicMod.LOGGER.info("SpongeAPI not found", e);
			else
				reflectionmedicMod.LOGGER.info("SpongeAPI not found");
		}
