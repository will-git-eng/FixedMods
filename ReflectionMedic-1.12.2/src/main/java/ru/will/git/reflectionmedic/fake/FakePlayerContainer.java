package ru.will.git.reflectionmedic.fake;

import ru.will.git.reflectionmedic.util.EventUtils;
import ru.will.git.reflectionmedic.util.ExplosionByPlayer;
...
{
	private static final String NBT_FAKE_NAME = "reflectionmedic_fakeName";
	private static final String NBT_FAKE_ID_MOST = "reflectionmedic_fakeUUID_Most";
	private static final String NBT_FAKE_ID_LEAST = "reflectionmedic_fakeUUID_Least";
