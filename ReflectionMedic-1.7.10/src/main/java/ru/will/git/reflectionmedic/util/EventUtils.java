...
import static ru.will.git.reflectionmedic.util.ConvertUtils.*;
...
public final class EventUtils
{
	public static boolean cantBreak(@Nonnull EntityPlayer player, int x, int y, int z)
	{
		try
		{
			...
			reflectionmedic.callEvent(event);
			return event.isCancelled();
		}
		catch (Throwable throwable)
		{
			reflectionmedic.error(throwable, "Failed call BlockBreakEvent: [Player: {}, X:{}, Y:{}, Z:{}]", String.valueOf(player), x, y, z);
			return true;
		}
	}
	...
	public static boolean cantDamage(@Nonnull Entity attacker, @Nonnull Entity victim)
	{
		...
		{
			reflectionmedic.error(throwable, "Failed call EntityDamageByEntityEvent: [Attacker: {}, Victim: {}]", String.valueOf(attacker), String.valueOf(victim));
			return true;
		}
	}
			...
			@Nonnull EntityPlayer player, @Nullable ItemStack stack, int x, int y, int z, @Nonnull ForgeDirection side)
	{
		...
		{
			reflectionmedic.error(throwable, "Failed call PlayerInteractEvent: [Player: {}, Item: {}, X:{}, Y:{}, Z:{}, Side: {}]", String.valueOf(player), String.valueOf(stack), x, y, z, String.valueOf(side));
			return true;
		}
	}
	...
	public static boolean cantFromTo(@Nonnull World world, int fromX, int fromY, int fromZ, int toX, int toY, int toZ)
	{
		...
		{
			reflectionmedic.error(throwable, "Failed call BlockFromToEvent: [FromX: {}, FromY: {}, FromZ: {}, ToX: {}, ToY: {}, ToZ: {}]", fromX, fromY, fromZ, toX, toY, toZ);
			return true;
		}
	}
			...
			@Nonnull World world, int fromX, int fromY, int fromZ, @Nonnull ForgeDirection direction)
	{
		...
		{
			reflectionmedic.error(throwable, "Failed call BlockFromToEvent: [FromX: {}, FromY: {}, FromZ: {}, Direction: {}]", fromX, fromY, fromZ, String.valueOf(direction));
			return true;
		}
	}
	...
	public static boolean isInPrivate(@Nonnull World world, int x, int y, int z)
	{
		...
		{
			reflectionmedic.error(throwable, "Failed check private: [World: {}, X: {}, Y: {}, Z: {}]", world.getWorldInfo().getWorldName(), x, y, z);
			return true;
		}
	}
	...
	public static boolean isPrivateMember(@Nonnull EntityPlayer player, int x, int y, int z)
	{
		...
		{
			reflectionmedic.error(throwable, "Failed check private member: [Player: {}, X: {}, Y: {}, Z: {}]", String.valueOf(player), x, y, z);
			return true;
		}
	}
	...
	public static boolean isPrivateOwner(@Nonnull EntityPlayer player, int x, int y, int z)
	{
		...
		{
			reflectionmedic.error(throwable, "Failed check private owner: [Player: {}, X: {}, Y: {}, Z: {}]", String.valueOf(player), x, y, z);
			return true;
		}
	}
	...
	public static boolean hasPermission(@Nullable EntityPlayer player, @Nonnull String permission)
	{
		...
		{
			reflectionmedic.error(throwable, "Failed checking permission: [Player: {}, Permission: {}]", player, permission);
			return false;
		}
	}
	...
	public static boolean hasPermission(@Nullable UUID playerId, @Nonnull String permission)
	{
		...
		{
			reflectionmedic.error(throwable, "Failed checking permission: [Player name: {}, Permission: {}]", playerId, permission);
			return false;
		}
	}
	...
	public static boolean hasPermission(@Nullable String playerName, @Nonnull String permission)
	{
		...
		{
			reflectionmedic.error(throwable, "Failed checking permission: [Player UUID: {}, Permission: {}]", playerName, permission);
			return false;
		}
	}
}
