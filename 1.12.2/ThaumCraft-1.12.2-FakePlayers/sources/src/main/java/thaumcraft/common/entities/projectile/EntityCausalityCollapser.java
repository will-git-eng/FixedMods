...
public class EntityCausalityCollapser extends EntityThrowableByPlayer
{
	...
	protected void onImpact(RayTraceResult par1RayTraceResult)
	{
		if (!this.world.isRemote)
		{
			...
			this.fake.createExplosion(this, this.posX, this.posY, this.posZ, 2.0F, true);
			

			for (EntityFluxRift fr : EntityUtils.getEntitiesInRange(this.world, this.posX, this.posY, this.posZ, this, EntityFluxRift.class, 3.0D))
			{
				fr.setCollapse(true);
			}
