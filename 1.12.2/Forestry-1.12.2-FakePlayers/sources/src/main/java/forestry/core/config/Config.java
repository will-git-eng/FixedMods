...
public class Config
{
	...
	public static boolean isValidOreDim(int dimID)
	...
	private static void loadConfigCommon(Side side)
	{
		...
		String[] gameModes = { "EASY", "NORMAL", "HARD", "OP" };
		...
		String[] allStamps = { "1n", "2n", "5n", "10n", "20n", "50n", "100n" };
		String[] defaultCollectors = { "20n", "50n", "100n" };
		...
		String[] availableStructures = { "alveary3x3", "farm3x3", "farm3x4", "farm3x5", "farm4x4", "farm5x5" };
