...
public abstract class AEBaseTileBlock extends AEBaseBlock implements ITileEntityProvider
{
	...
	{
		return new ExtendedBlockState(this, this.getAEStates(), new IUnlistedProperty[] { FORWARD, UP });
	}
	...
	{
		// TODO gamerforrEA code start
		if (EventConfig.dropInvOnBreak)
		// TODO gamerforrEA code end
		{
