...
public final class ExplosionByPlayer extends Explosion
{
	...
	public static ExplosionByPlayer createExplosion(EntityPlayer player, World world, Entity entity, double x, double y, double z, float size, boolean smoke)
	{
		return newExplosion(player, world, entity, x, y, z, size, false, smoke);
	}

	public static ExplosionByPlayer newExplosion(EntityPlayer player, World world, Entity entity, double x, double y, double z, float size, boolean flame, boolean smoke)
	{
