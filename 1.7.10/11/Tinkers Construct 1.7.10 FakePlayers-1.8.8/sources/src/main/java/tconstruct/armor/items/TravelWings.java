...
public class TravelWings extends TravelGear
{
	...
	protected void registerModifiers(IIconRegister IIconRegister)
	{
		...
		this.modifiers[0] = IIconRegister.registerIcon("tinker:" + this.textureFolder + "/" + "wings" + "_" + "doublejump");
		this.modifiers[1] = IIconRegister.registerIcon("tinker:" + this.textureFolder + "/" + "wings" + "_" + "featherfall");
		this.modifiers[4] = IIconRegister.registerIcon("tinker:" + this.textureFolder + "/" + "wings" + "_" + "moss");
