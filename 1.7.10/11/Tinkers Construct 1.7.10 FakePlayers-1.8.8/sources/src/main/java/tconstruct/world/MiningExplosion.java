...
public class MiningExplosion extends Explosion
{
	...
	public void doExplosionA()
	{
				...
				for (k = 0; k < this.field_77289_h; ++k)
				{
					if (i == 0 || i == this.field_77289_h - 1 || j == 0 || j == this.field_77289_h - 1 || k == 0 || k == this.field_77289_h - 1)
					{
						...
						for (float f2 = 0.3F; f1 > 0.0F; f1 -= f2 * 0.75F)
						{
							...
							{
								Block block = k1;
								float f3 = this.exploder != null ? this.exploder.func_145772_a(this, this.world, l, i1, j1, block) : block.getExplosionResistance(this.exploder, this.world, l, i1, j1, this.explosionX, this.explosionY, this.explosionZ);
								f1 -= (f3 + 0.8F) * f2 * 0.25f;
							}
		...
		List<Entity> list = this.world.getEntitiesWithinAABBExcludingEntity(this.exploder, AxisAlignedBB.getBoundingBox(i, k, i2, j, l1, j2));
	...
	public void doExplosionB(boolean par1)
	{
		...
		if (this.isSmoking)
		{
			...
			while (iterator.hasNext())
			{
				...
				Block l = this.world.getBlock(i, j, k);
				...
				if (l != Blocks.air)
					...
					if (EventUtils.cantBreak(this.player, i, j, k))
