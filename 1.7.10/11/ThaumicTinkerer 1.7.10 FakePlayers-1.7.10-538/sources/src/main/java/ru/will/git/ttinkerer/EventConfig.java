...
public final class EventConfig
{
	...
	public static void init()
	{
		try
		{
			...
			summonerOnlyOnePerChunk = cfg.getBoolean("summonerOnlyOnePerChunk", c, summonerOnlyOnePerChunk, "Запрет ставить больше 1 Пьедестала некроманта на чанк");
			focusDislocationNotifyNeighbors = cfg.getBoolean("focusDislocationNotifyNeighbors", c, focusDislocationNotifyNeighbors, "При использовании Набалдашника Перемещения обновлять соседние блоки (фикс дюпа)");
