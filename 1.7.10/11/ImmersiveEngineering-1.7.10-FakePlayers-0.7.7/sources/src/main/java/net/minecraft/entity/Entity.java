...
public abstract class Entity
{
	...
	protected void setSize(float p_70105_1_, float p_70105_2_)
	{
		...
		if (p_70105_1_ != this.width || p_70105_2_ != this.height)
		{
			...
			if (this.width > f2 && !this.firstUpdate && !this.worldObj.isRemote)
				this.moveEntity(f2 - this.width, 0.0D, f2 - this.width);
		}
	...
	public void setPosition(double p_70107_1_, double p_70107_3_, double p_70107_5_)
	{
		...
		this.boundingBox.setBounds(p_70107_1_ - f, p_70107_3_ - this.yOffset + this.ySize, p_70107_5_ - f, p_70107_1_ + f, p_70107_3_ - this.yOffset + this.ySize + f1, p_70107_5_ + f);
	}
	...
	public void setAngles(float p_70082_1_, float p_70082_2_)
	{
		...
		this.rotationYaw = (float) (this.rotationYaw + p_70082_1_ * 0.15D);
		this.rotationPitch = (float) (this.rotationPitch - p_70082_2_ * 0.15D);
	...
	public void onEntityUpdate()
	{
		...
		if (this.isSprinting() && !this.isInWater())
		{
			...
			i = MathHelper.floor_double(this.posY - 0.20000000298023224D - this.yOffset);
			int k = MathHelper.floor_double(this.posZ);
			Block block = this.worldObj.getBlock(j, i, k);

			if (block.getMaterial() != Material.air)
				this.worldObj.spawnParticle("blockcrack_" + Block.getIdFromBlock(block) + "_" + this.worldObj.getBlockMetadata(j, i, k), this.posX + (this.rand.nextFloat() - 0.5D) * this.width, this.boundingBox.minY + 0.1D, this.posZ + (this.rand.nextFloat() - 0.5D) * this.width, -this.motionX * 4.0D, 1.5D, -this.motionZ * 4.0D);
		}
	...
	public boolean isOffsetPositionInLiquid(double p_70038_1_, double p_70038_3_, double p_70038_5_)
	{
		...
		return list.isEmpty() && !this.worldObj.isAnyLiquid(axisalignedbb);
	}
	...
	public void moveEntity(double p_70091_1_, double p_70091_3_, double p_70091_5_)
	{
		...
		else
		{
			...
			if (this.canTriggerWalking() && !flag && this.ridingEntity == null)
			{
				...
				k = MathHelper.floor_double(this.posY - 0.20000000298023224D - this.yOffset);
				...
				this.distanceWalkedModified = (float) (this.distanceWalkedModified + MathHelper.sqrt_double(d12 * d12 + d11 * d11) * 0.6D);
				this.distanceWalkedOnStepModified = (float) (this.distanceWalkedOnStepModified + MathHelper.sqrt_double(d12 * d12 + d10 * d10 + d11 * d11) * 0.6D);
	...
	{
		if (!this.isImmuneToFire)
			this.attackEntityFrom(DamageSource.inFire, p_70081_1_);
	}
	...
	public void moveFlying(float p_70060_1_, float p_70060_2_, float p_70060_3_)
	{
		...
		if (f3 >= 1.0E-4F)
		{
			...
			this.motionX += p_70060_1_ * f5 - p_70060_2_ * f4;
			this.motionZ += p_70060_2_ * f5 + p_70060_1_ * f4;
		}
	}
	...
	public void setPositionAndRotation(double p_70080_1_, double p_70080_3_, double p_70080_5_, float p_70080_7_, float p_70080_8_)
	{
		...
		this.ySize = 0.0F;
		double d3 = this.prevRotationYaw - p_70080_7_;
	...
	public void setLocationAndAngles(double p_70012_1_, double p_70012_3_, double p_70012_5_, float p_70012_7_, float p_70012_8_)
	{
		...
		this.lastTickPosY = this.prevPosY = this.posY = p_70012_3_ + this.yOffset;
	...
	public void writeToNBT(NBTTagCompound p_70109_1_)
	{
		try
		{
			...
			if (this.customEntityData != null)
				p_70109_1_.setTag("ForgeData", this.customEntityData);
	...
	public void readFromNBT(NBTTagCompound p_70020_1_)
	{
		try
		{
			...
			if (p_70020_1_.hasKey("ForgeData"))
				this.customEntityData = p_70020_1_.getCompoundTag("ForgeData");
	...
	public EntityItem entityDropItem(ItemStack p_70099_1_, float p_70099_2_)
	{
		...
		{
			EntityItem entityitem = new EntityItem(this.worldObj, this.posX, this.posY + p_70099_2_, this.posZ, p_70099_1_);
	...
	public boolean isEntityInsideOpaqueBlock()
	{
		for (int i = 0; i < 8; ++i)
		{
			...
			int j = MathHelper.floor_double(this.posX + f);
			int k = MathHelper.floor_double(this.posY + this.getEyeHeight() + f1);
			int l = MathHelper.floor_double(this.posZ + f2);
	...
	protected void setFlag(int p_70052_1_, boolean p_70052_2_)
	{
		...
		if (p_70052_2_)
			this.dataWatcher.updateObject(0, (byte) (b0 | 1 << p_70052_1_));
		else
			this.dataWatcher.updateObject(0, (byte) (b0 & ~(1 << p_70052_1_)));
	}
	...
	{
		return p_145772_6_.getExplosionResistance(this, p_145772_2_, p_145772_3_, p_145772_4_, p_145772_5_, this.posX, this.posY + this.getEyeHeight(), this.posZ);
	}
