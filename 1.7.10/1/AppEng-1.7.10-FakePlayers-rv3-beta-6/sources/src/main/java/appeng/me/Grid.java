...
public class Grid implements IGrid
{
	...
	public final Collection<IGridNode> getMachinesCopy(Class<? extends IGridHost> c)
	{
		MachineSet s = this.machines.get(c);
		return s == null || s.isEmpty() ? Collections.<IGridNode>emptyList() : new ArrayList<IGridNode>(s);
	}

	public final void addMachinesTo(Class<? extends IGridHost> c, Collection<IGridNode> collection)
	{
		MachineSet s = this.machines.get(c);
		if (s != null)
			collection.addAll(s);
