...
import ru.will.git.ae.ModUtils;
...
public class CachedPlane
{
	...
	public CachedPlane(final FakePlayer player, final World w, final int minX, final int minY, final int minZ, final int maxX, final int maxY, final int maxZ) 
	{
		this.world = w;
